...
\documentclass[restricted,noindent]{aisecreport}
...
Unikraft supports networking via the LWIP library\footnote{\url{https://www.nongnu.org/lwip/2_1_x/index.html}} which was originally developed for embedded systems but also has support for POSIX networking. Security mechanisms such as encryption and an SSL connection are done with OpenSSL\footnote{\url{https://github.com/unikraft/lib-openssl}}. Finally, Unikraft also has experimental support for several hardware extensions\footnote{\url{https://github.com/unikraft/unikraft/pull/474}}
\footnote{\url{https://github.com/unikraft/unikraft/pull/1094}}
\footnote{\url{https://github.com/unikraft/unikraft/pull/964}}
that support confidential computing (see section \ref{section:confidential_computing}), which is the main reason we chose Unikraft for our project.
...
\subsection{Integrating the libraries in Unikraft}
